    ...
    <div className="min-h-screen flex flex-col bg-surface-container-low">
      <main className="flex-1 flex items-center justify-center pt-20 px-6 py-12">
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 bg-white shadow-2xl overflow-hidden border border-surface-container-high">
          {/* Image side */}
          <div className="relative hidden md:block bg-[#FFFBF2]">
            <div
          ...
          <div className="p-10 md:p-16">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <div className="relative mt-0.5 flex-shrink-0">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`w-4 h-4 border transition-colors ${newsletter ? 'bg-[#13243A] border-[#13243A]' : 'bg-white border-gray-300'} flex items-center justify-center`}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#13243A] text-white py-4 font-label text-xs tracking-[0.2em] uppercase hover:bg-black transition-colors disabled:opacity-50"
              >
