    ...
    <div className="min-h-screen bg-white" dir="rtl">
      <main className="px-6 pb-20 pt-32 md:px-12">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mt-3 font-['Noto_Serif'] text-4xl text-[#13243A]">מדיניות ביטולים והחזרות</h1>
          <p className="mt-2 font-['Manrope'] text-sm text-[#8AA3B8]">בהתאם לדיני הגנת הצרכן בישראל</p>

          <div className="mt-10 space-y-8 font-['Manrope'] leading-relaxed text-[#5A6B7F]">
            <section className="bg-[#FFFBF2] p-6">
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">ביטול עסקה - עיקרי הדברים</h2>
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">תנאים להחזרה</h2>
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">דמי ביטול והחזר כספי</h2>
            ...
            <section className="bg-background p-6">
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">איך מבטלים עסקה?</h2>
