    ...
    <div className="min-h-screen bg-white" dir="rtl">
      <main className="px-6 pb-20 pt-32 md:px-12">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-2 font-['Manrope'] text-sm text-[#888]">יעד הנגשה: תקן ישראלי 5568 ו-WCAG 2.1 ברמה AA</p>

          <div className="mt-10 space-y-8 font-['Manrope'] leading-relaxed text-[#333]">
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#111]">מחויבות לנגישות</h2>
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#111]">התאמות נגישות באתר</h2>
            ...
            <section className="bg-[#f7f7f7] p-6">
              <h2 className="font-['Noto_Serif'] text-xl text-[#111]">רכז נגישות</h2>
