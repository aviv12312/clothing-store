...
function Field({ label, value }) {
  return (
    <p>
      <strong>{label}:</strong>{' '}
      <span className={isPlaceholder(value) ? 'rounded bg-yellow-100 px-1 text-[#5f4b00]' : ''}>{value}</span>
    </p>
  );
}
          ...
          <div className="mt-10 space-y-8 font-['Manrope'] leading-relaxed text-[#333]">
            ...
            <section>
              ...
              <ul className="mt-3 list-inside list-disc space-y-2 text-sm">
                ...
                <li>המשלוח מתבצע על ידי <span className="rounded bg-yellow-100 px-1 text-[#5f4b00]">{BUSINESS_INFO.shippingCompany}</span>.</li>
            ...
            <section>
              ...
              <p className="mt-3 text-sm">
                מדיניות הביטולים וההחזרות המלאה זמינה בעמוד <a href="/legal/returns" className="underline text-[#111]">ביטולים והחזרות</a>.
              </p>
            </section>
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#111]">7. אחריות</h2>
              <p className="mt-3 text-sm">
            ...
            <section>
              ...
              <p className="mt-3 text-sm">
                על תנאים אלה יחולו דיני מדינת ישראל. סמכות השיפוט המקומית תהיה לבתי המשפט בעיר <span className="rounded bg-yellow-100 px-1 text-[#5f4b00]">{BUSINESS_INFO.jurisdictionCity}</span>.
              </p>
            </section>
