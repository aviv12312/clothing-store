...
function Field({ label, value }) {
  return (
    <p>
      <strong>{label}:</strong>{' '}
      <span className={isPlaceholder(value) ? 'rounded bg-yellow-100 px-1 text-[#9C5A40]' : ''}>{value}</span>
    </p>
  );
}
    ...
    <div className="min-h-screen bg-white" dir="rtl">
      <main className="px-6 pb-20 pt-32 md:px-12">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mt-3 font-['Noto_Serif'] text-4xl text-[#13243A]">תקנון ותנאי שימוש</h1>
          ...
          <div className="mt-10 space-y-8 font-['Manrope'] leading-relaxed text-[#5A6B7F]">
            <section className="bg-[#FFFBF2] p-6">
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">1. פרטי העסק</h2>
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">2. כללי</h2>
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">3. הזמנות ותשלום</h2>
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">4. משלוחים</h2>
              <ul className="mt-3 list-inside list-disc space-y-2 text-sm">
                <li>זמן אספקה משוער: 3-7 ימי עסקים, אלא אם צוין אחרת.</li>
                <li>המשלוח מתבצע על ידי <span className="rounded bg-yellow-100 px-1 text-[#9C5A40]">{BUSINESS_INFO.shippingCompany}</span>.</li>
                <li>עלויות משלוח, אם קיימות, יוצגו לפני השלמת הרכישה.</li>
              </ul>
            </section>

            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">5. ביטולים והחזרות</h2>
              <p className="mt-3 text-sm">
                מדיניות הביטולים וההחזרות המלאה זמינה בעמוד <a href="/legal/returns" className="underline text-[#13243A]">ביטולים והחזרות</a>.
              </p>
            </section>

            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">6. קניין רוחני</h2>
              <p className="mt-3 text-sm">
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">7. אחריות</h2>
              <p className="mt-3 text-sm">
            ...
            <section>
              <h2 className="font-['Noto_Serif'] text-xl text-[#13243A]">8. סמכות שיפוט</h2>
              <p className="mt-3 text-sm">
                על תנאים אלה יחולו דיני מדינת ישראל. סמכות השיפוט המקומית תהיה לבתי המשפט בעיר <span className="rounded bg-yellow-100 px-1 text-[#9C5A40]">{BUSINESS_INFO.jurisdictionCity}</span>.
              </p>
            </section>
